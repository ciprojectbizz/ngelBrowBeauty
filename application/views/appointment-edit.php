            ...
            <div class="card" style="border-radius: 15px">
              ...
              <div class="card-body">
                ...
                <div class="form-group ">
                 ...
                 <div class="form-group ">
                    <label for="amount" class="col-sm-2 control-label">Total Amount
                    <i class="required">*</i>
                    </label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group ">
                      <label for="date" class="col-sm-2 control-label">Appointment Date
                      <i class="required">*</i>
                      </label>
                        <div class="col-sm-8">
                             <input type="date" class="form-control" name="date" id="date" placeholder="Appointment Date" value="">
                        </div>
                  </div>
